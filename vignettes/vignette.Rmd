...
Since it was proposed in 1982 in a working paper by Hodrick and Prescott, it has been widely used in empirical
macroeconomics thanks to its simplicity. As an operational algorithm, its pros and cons have been debated over
...
In practice, @hodrick1997postwar recommend $\lambda=1600$ for quarterly data, and this number and its sampling frequency adjusted version @ravn2002adjusting are widely adopted in applications. However, recent research 
(@phillips2015business; hamilton2017you) find the "gold standard" is unsatisfactory for the length of time series that often encountered in macroeconomic studies.
...
bx_nonstop <- BoostedHP(IRE, lambda = lam, iter= TRUE, 
                        stopping = "nonstop")$trend

matplot( y = cbind(IRE, bx_HP, bx_BIC, bx_ADF, bx_nonstop), 
         type = "l", x = 1981:2016,
         ylab = "value", xlab = "year", main = "Ireland Annual GDP")
